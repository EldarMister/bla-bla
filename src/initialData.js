...
const initialChannels = [
    { id: 'general', name: 'Общий чат', type: 'public', participants: [] },
    { id: 'random', name: 'Флудилка', type: 'public', participants: [] },
    { id: 'dev', name: 'Разработка', type: 'public', participants: [] }
];

// 3. Функция инициализации базы данных
function initStorage() {
    // Проверяем, есть ли пользователи в памяти браузера. Если нет — загружаем наш список.
...
export { usersData, initialChannels };